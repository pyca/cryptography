...
.. function:: load_der_ocsp_request(data, backend)
    ...
    :param backend: A backend supporting the
        :class:`~cryptography.hazmat.backends.interfaces.OCSPBackend`
        interface.
    ...
    .. doctest::
        ...
        >>> req = ocsp.load_der_ocsp_request(der_ocsp_req, default_backend())
        >>> len(req)
        1
