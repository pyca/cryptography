...
For more information about this sort of issue, Wikipedia has a section
about `Constant-time challenges`_.
...
.. _`Constant-time challenges`: https://en.wikipedia.org/wiki/Timing_attack#Constant-time_challenges
