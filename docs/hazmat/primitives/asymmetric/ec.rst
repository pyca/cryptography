...
.. class:: EllipticCurve
    ...
    .. attribute:: degree
        ...
        The bit length of the underlying prime field. For current NIST curves
        degree and order are the same size.
    ...
    .. attribute:: order
        ...
        The bit length of the group generated by the base point. For current
        NIST curves degree and order are the same size.
