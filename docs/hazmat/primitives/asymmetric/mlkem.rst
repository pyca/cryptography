...
The hybrid KEM combines ML-KEM-768 with X25519 (X-Wing construction), providing
security against both classical and quantum adversaries. It is registered with
HPKE KEM ID ``0x647A`` and used via
:attr:`~cryptography.hazmat.primitives.hpke.KEM.MLKEM768_X25519`.
...
.. class:: MLKEM768X25519PrivateKey
    ...
    .. classmethod:: generate()
        ...
        Generate an ML-KEM-768/X25519 hybrid private key.

        :returns: :class:`MLKEM768X25519PrivateKey`
    ...
    .. classmethod:: from_seed_bytes(data)
        ...
        Load an ML-KEM-768/X25519 private key from a 32-byte seed.
    ...
    .. method:: decapsulate(ciphertext)
        ...
        Decapsulate a ciphertext using the hybrid KEM, returning the 32-byte
        shared secret.

        :param ciphertext: The ciphertext to decapsulate (1120 bytes).
        :type ciphertext: :term:`bytes-like`
    ...
    .. method:: private_bytes_raw()
        ...
        :return bytes: The 32-byte raw seed.
...
.. class:: MLKEM768X25519PublicKey
    ...
    .. classmethod:: from_public_bytes(data)
        ...
        :param bytes data: 1216 byte public key (ML-KEM-768 public key followed
            by X25519 public key).

        :returns: :class:`MLKEM768X25519PublicKey`

        :raises ValueError: If the public key is not 1216 bytes.
