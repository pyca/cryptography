...
.. class:: GCM(initialization_vector, tag=None, min_tag_length=16)
    ...
    **This mode does not require padding.**
    ...
    .. note::
        ...
        is **not recommended** as it makes it easier to messages, and also
        potentially leaks the key (`NIST SP-800-38D`_ recommends 96-:term:`bits`
        or greater).  Applications wishing to allow truncation must pass the
