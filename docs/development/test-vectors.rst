...
* ``admissions_extension_optional_data_not_provided.pem`` -
  ...
  authority or profession infos, a profession info missing naming authority
  or profession OIDs or the registration number etc).
...
* ``pkcs7/enveloped-aes-256-cbc.pem`` - A PEM encoded PKCS7 file with 
  enveloped data, encrypted using AES-256-CBC under the public key of 
