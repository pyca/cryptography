...
#define CRYPTOGRAPHY_LIBRESSL_LESS_THAN_333 \
    (LIBRESSL_VERSION_NUMBER < 0x3030300f)
#else
#define CRYPTOGRAPHY_LIBRESSL_LESS_THAN_332 (0)
#define CRYPTOGRAPHY_LIBRESSL_LESS_THAN_333 (0)
#endif
...
static const int CRYPTOGRAPHY_LIBRESSL_LESS_THAN_333;
"""
