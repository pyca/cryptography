...
#define CRYPTOGRAPHY_OPENSSL_LESS_THAN_102I \
    (OPENSSL_VERSION_NUMBER < 0x1000209f && !CRYPTOGRAPHY_LIBRESSL_IS_OPENSSL_1_1_0_OR_GREATER)
#define CRYPTOGRAPHY_OPENSSL_LESS_THAN_110 \
    (OPENSSL_VERSION_NUMBER < 0x10100000 && !CRYPTOGRAPHY_LIBRESSL_IS_OPENSSL_1_1_0_OR_GREATER)
#define CRYPTOGRAPHY_OPENSSL_LESS_THAN_110PRE4 \
    (OPENSSL_VERSION_NUMBER < 0x10100004 && !CRYPTOGRAPHY_LIBRESSL_IS_OPENSSL_1_1_0_OR_GREATER)
#define CRYPTOGRAPHY_OPENSSL_LESS_THAN_110PRE5 \
    (OPENSSL_VERSION_NUMBER < 0x10100005 && !CRYPTOGRAPHY_LIBRESSL_IS_OPENSSL_1_1_0_OR_GREATER)
#define CRYPTOGRAPHY_OPENSSL_LESS_THAN_110PRE6 \
    (OPENSSL_VERSION_NUMBER < 0x10100006 && !CRYPTOGRAPHY_LIBRESSL_IS_OPENSSL_1_1_0_OR_GREATER)
"""
