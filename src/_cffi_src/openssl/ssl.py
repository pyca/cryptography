...
const SSL_METHOD *TLS_method = SSLv23_method;
const SSL_METHOD *TLS_client_method = SSLv23_client_method;
const SSL_METHOD *TLS_server_method = SSLv23_server_method;
#else
