...
/* Added in 1.1.0 but we need it in all versions now due to the great
   opaquing. */
/* This function was also added in LibreSSL 2.5.1. */
#if CRYPTOGRAPHY_LIBRESSL_LESS_THAN_251 || CRYPTOGRAPHY_OPENSSL_LESS_THAN_110
...
/* These functions were also added in LibreSSL 2.7.0. */
...
/* These functions do not exist in LibreSSL. */
