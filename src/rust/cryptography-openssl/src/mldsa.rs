...
impl MlDsaVariant {
    ...
    fn from_pkey<T: openssl::pkey::HasPublic>(pkey: &openssl::pkey::PKeyRef<T>) -> MlDsaVariant {
...
pub fn sign(
    ...
    let (signature_bytes, sign_func) = match variant {
