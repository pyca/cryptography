...
use cryptography_x509::common::{AlgorithmIdentifier, AlgorithmParameters, Asn1ReadableOrWritable};
...
fn load_der_x509_certificate(
    ...
    warn_if_invalid_ecdsa_params(py, raw.borrow_value().signature_alg.clone())?;
