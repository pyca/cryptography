...
from cryptography.x509 import certificate_transparency as ct
...
class Sct:
    @property
    def version(self) -> ct.Version: ...
    @property
    def log_id(self) -> bytes: ...
    @property
    def timestamp(self) -> datetime.datetime: ...
    @property
    def entry_type(self) -> ct.LogEntryType: ...
    @property
    def signature_hash_algorithm(self) -> hashes.HashAlgorithm: ...
    @property
    def signature_algorithm(self) -> ct.SignatureAlgorithm: ...
    @property
