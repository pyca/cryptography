...
@utils.register_interface(dh.DHParametersWithNumbers)
...
@utils.register_interface(dh.DHPrivateKeyWithNumbers)
...
@utils.register_interface(dh.DHPublicKeyWithNumbers)
