...
class MlDsa44PublicKey(metaclass=abc.ABCMeta):
    ...
    def from_public_bytes(cls, data: bytes) -> MlDsa44PublicKey:
        ...
        return typing.cast(
            MlDsa44PublicKey, rust_openssl.mldsa.from_public_bytes(data)
        )
...
if hasattr(rust_openssl, "mldsa") and hasattr(
    rust_openssl.mldsa, "MlDsa44PublicKey"
):
...
class MlDsa44PrivateKey(metaclass=abc.ABCMeta):
    ...
    def generate(cls) -> MlDsa44PrivateKey:
        ...
        return typing.cast(
            MlDsa44PrivateKey, rust_openssl.mldsa.generate_key()
        )
    ...
    def from_seed_bytes(cls, data: Buffer) -> MlDsa44PrivateKey:
        ...
        return typing.cast(
            MlDsa44PrivateKey, rust_openssl.mldsa.from_seed_bytes(data)
        )
...
if hasattr(rust_openssl, "mldsa") and hasattr(
    rust_openssl.mldsa, "MlDsa44PrivateKey"
):
