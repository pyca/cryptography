...
class MLKEM768X25519PublicKey(metaclass=abc.ABCMeta):
    @classmethod
    def from_public_bytes(cls, data: Buffer) -> MLKEM768X25519PublicKey:
        from cryptography.hazmat.backends.openssl.backend import backend

        if not backend.mlkem_supported():
            raise UnsupportedAlgorithm(
                "ML-KEM-768/X25519 is not supported by this backend.",
                _Reasons.UNSUPPORTED_PUBLIC_KEY_ALGORITHM,
            )

        return rust_openssl.mlkem768_x25519.from_public_bytes(data)
    ...
    def public_bytes_raw(self) -> bytes:
        ...
        The public key is 1,216 bytes for ML-KEM-768/X25519
        (1,184 bytes of ML-KEM-768 public key followed by
    ...
    @abc.abstractmethod
    def __copy__(self) -> MLKEM768X25519PublicKey:
        """
        Returns a copy.
        """

    @abc.abstractmethod
    def __deepcopy__(self, memo: dict) -> MLKEM768X25519PublicKey:
        """
        Returns a deep copy.
        """


if hasattr(rust_openssl, "mlkem768_x25519"):
    MLKEM768X25519PublicKey.register(
        rust_openssl.mlkem768_x25519.MLKEM768X25519PublicKey
    )


class MLKEM768X25519PrivateKey(metaclass=abc.ABCMeta):
    @classmethod
    def generate(cls) -> MLKEM768X25519PrivateKey:
        from cryptography.hazmat.backends.openssl.backend import backend
        ...
        return rust_openssl.mlkem768_x25519.generate_key()

    @classmethod
    def from_seed_bytes(cls, data: Buffer) -> MLKEM768X25519PrivateKey:
        from cryptography.hazmat.backends.openssl.backend import backend
        ...
        return rust_openssl.mlkem768_x25519.from_seed_bytes(data)
    ...
    def public_key(self) -> MLKEM768X25519PublicKey:
        """
        The MLKEM768X25519PublicKey derived from this private key.
        """
    ...
    @abc.abstractmethod
    def __copy__(self) -> MLKEM768X25519PrivateKey:
        """
        Returns a copy.
        """

    @abc.abstractmethod
    def __deepcopy__(self, memo: dict) -> MLKEM768X25519PrivateKey:
        """
        Returns a deep copy.
        """
...
if hasattr(rust_openssl, "mlkem768_x25519"):
    MLKEM768X25519PrivateKey.register(
        rust_openssl.mlkem768_x25519.MLKEM768X25519PrivateKey
    )
