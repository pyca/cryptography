...
class MLKEM512PublicKey(metaclass=abc.ABCMeta):
    @classmethod
    def from_public_bytes(cls, data: Buffer) -> MLKEM512PublicKey:
        from cryptography.hazmat.backends.openssl.backend import backend

        if not backend.mlkem_supported():
            raise UnsupportedAlgorithm(
                "ML-KEM-512 is not supported by this backend.",
                _Reasons.UNSUPPORTED_PUBLIC_KEY_ALGORITHM,
            )

        return rust_openssl.mlkem.from_mlkem512_public_bytes(data)
    ...
    def public_bytes_raw(self) -> bytes:
        ...
        The public key is 800 bytes for ML-KEM-512.
        """
...
if hasattr(rust_openssl, "mlkem"):
    MLKEM512PublicKey.register(rust_openssl.mlkem.MLKEM512PublicKey)
...
class MLKEM512PrivateKey(metaclass=abc.ABCMeta):
    ...
    def generate(cls) -> MLKEM512PrivateKey:
        ...
        return rust_openssl.mlkem.generate_mlkem512_key()

    @classmethod
    def from_seed_bytes(cls, data: Buffer) -> MLKEM512PrivateKey:
        from cryptography.hazmat.backends.openssl.backend import backend
        ...
        return rust_openssl.mlkem.from_mlkem512_seed_bytes(data)
    ...
    def public_key(self) -> MLKEM512PublicKey:
        """
        The MLKEM512PublicKey derived from this private key.
        """
...
if hasattr(rust_openssl, "mlkem"):
    MLKEM512PrivateKey.register(rust_openssl.mlkem.MLKEM512PrivateKey)
