...
* Deprecated  :meth:`cryptography.hazmat.primitives.asymmetric.ec.EllipticCurvePublicNumbers.from_encoded_point` in favor of :meth:`cryptography.hazmat.primitives.asymmetric.ec.EllipticCurvePublicKey.from_encoded_point` which checks that the resulting point is on the curve, and supports compressed points
