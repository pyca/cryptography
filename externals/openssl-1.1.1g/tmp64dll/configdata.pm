#! C:\Strawberryx64\perl\bin\perl.exe
...
our %config = (
  ...
  CPPINCLUDES => [  ],
  CXXFLAGS => [  ],
  HASHBANGPERL => "C:\\Strawberryx64\\perl\\bin\\perl.exe",
  LD => "link",
  LDFLAGS => [ "/nologo /debug" ],
  LDLIBS => [  ],
  MT => "mt",
  MTFLAGS => [ "-nologo" ],
  PERL => "C:\\Strawberryx64\\perl\\bin\\perl.exe",
  RANLIB => "ranlib",
  RC => "rc",
  RCFLAGS => [  ],
  afalgeng => "",
  ...
  builddir => ".",
  cflags => [  ],
  conf_files => [ "C:\\cpython\\externals\\openssl-1.1.1g\\Configurations\\00-base-templates.conf", "C:\\cpython\\externals\\openssl-1.1.1g\\Configurations\\10-main.conf", "C:\\cpython\\externals\\openssl-1.1.1g\\Configurations\\50-masm.conf" ],
  cppflags => [  ],
  cxxflags => [  ],
  defines => [ "NDEBUG" ],
  ...
  perl_cmd => "C:\\Strawberryx64\\perl\\bin\\perl.exe",
  perl_version => "5.30.2",
