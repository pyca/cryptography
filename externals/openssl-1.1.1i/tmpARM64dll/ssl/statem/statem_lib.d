...
..\ssl\statem\statem_lib.c(135): warning C4133: 'function': incompatible types - from 'volatile int *' to 'volatile __int64 *'
..\ssl\statem\statem_lib.c(138): warning C4133: 'function': incompatible types - from 'volatile int *' to 'volatile __int64 *'
..\ssl\statem\statem_lib.c(144): warning C4133: 'function': incompatible types - from 'volatile int *' to 'volatile __int64 *'
..\ssl\statem\statem_lib.c(146): warning C4133: 'function': incompatible types - from 'volatile int *' to 'volatile __int64 *'
..\ssl\statem\statem_lib.c(425): warning C4267: '=': conversion from 'size_t' to 'unsigned int', possible loss of data
..\ssl\statem\statem_lib.c(1091): warning C4133: 'function': incompatible types - from 'volatile int *' to 'volatile __int64 *'
..\ssl\statem\statem_lib.c(1110): warning C4133: 'function': incompatible types - from 'volatile int *' to 'volatile __int64 *'
..\ssl\statem\statem_lib.c(1113): warning C4133: 'function': incompatible types - from 'volatile int *' to 'volatile __int64 *'
