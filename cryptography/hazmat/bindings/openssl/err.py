...
static const long X509_V_ERR_UNSUPPORTED_CONSTRALONG_TYPE = 0;
static const long X509_V_ERR_UNSUPPORTED_CONSTRALONG_SYNTAX = 0;
...
CONDITIONAL_NAMES = {
    ...
    "Cryptography_HAS_101_ERROR_CODES": [
        ...
        'X509_V_ERR_UNSUPPORTED_CONSTRALONG_TYPE',
        'X509_V_ERR_UNSUPPORTED_CONSTRALONG_SYNTAX',
