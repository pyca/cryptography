...
class Backend(object):
    ...
    def generate_elliptic_curve_private_key(self, curve):
        ...
        return _EllipticCurvePrivateKey(backend, ctx)

    def elliptic_curve_private_key_from_numbers(self, numbers):
        ec_key = self._ec_key_cdata_from_private_numbers(numbers)
        return _EllipticCurvePrivateKey(backend, ec_key)

    def elliptic_curve_public_key_from_numbers(self, numbers):
        ec_key = self._ec_key_cdata_from_public_numbers(numbers)
        return _EllipticCurvePublicKey(backend, ec_key)
...
class _EllipticCurvePrivateKey(object):
    ...
    def signer(self, signature_algorithm):
        return signature_algorithm.signer(self)

    def public_key(self):
        return _EllipticCurvePublicKey(self._backend, self._ec_key)
...
class _EllipticCurvePublicKey(object):
    ...
    def verifier(self, signature, signature_algorithm):
        return signature_algorithm.verifier(signature, self)
