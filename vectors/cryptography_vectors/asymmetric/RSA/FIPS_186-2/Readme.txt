...
3.  The file SigGen15_186-2.txt contains values for RSA PKCS#1 Ver 1.5 signature generation with the additional value d added to the file for testing purposes.
